...
def get_args():
    ...
    # Processing more than 5000 images will take a long time,
    # by which the list of images may even change.
    # So, by default, we don't process more than 5000 images on a single run.
    # This also helps preventing the workflow execution from running out of memory.
    obj.add_argument('-max_retrieved', type=int, default=5000) # 0 means all
